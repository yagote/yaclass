...
import com.ya.yaclass.vod.listener.SubjectListener;
...
/**
 * 课程科目 服务实现类
 * @author yagote    create 2023/3/6 11:35
 */
@Service
...
//                subjectEeVo.setParentId(subject.getParentId());
            ...
            throw new YaclassException(20001,"导出失败");
        }
    }
    ...
    public void importData(MultipartFile file) {
        try {
            ...
            throw new YaclassException(20001,"导入失败");
        }
    }
