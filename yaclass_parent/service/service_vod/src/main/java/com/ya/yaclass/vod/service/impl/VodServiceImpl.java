...
import com.ya.yaclass.vod.service.VodService;
import com.ya.yaclass.vod.utils.ConstantPropertiesUtil;
...
/**
 * 整合腾讯云点播
 * @author yagote    create 2023/3/7 11:51
 */
@Service
...
//    @Value("${tencent.video.appid}")      //没弄腾讯云点播，把这个注销掉了
    ...
    public String updateVideo() {
        ...
        try {
            ...
            // 业务方进行异常处理
            throw new YaclassException(20001,"上传视频失败");
        }
    }
    ...
    public void removeVideo(String fileId) {
        try{
            ...
            throw new YaclassException(20001,"删除视频失败");
        }
    }
    ...
    public Map<String, Object> getPlayAuth(Long courseId, Long videoId) {
        ...
        if(video == null) {
            throw new YaclassException(20001,"小节信息不存在");
        }
