package com.ya.yaclass.order.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.ya.yaclass.client.activity.CouponInfoFeignClient;
...
import com.ya.yaclass.model.order.OrderDetail;
...
import com.ya.yaclass.order.mapper.OrderInfoMapper;
import com.ya.yaclass.order.service.OrderDetailService;
import com.ya.yaclass.order.service.OrderInfoService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.ya.yaclass.utils.AuthContextHolder;
import com.ya.yaclass.utils.OrderNoUtils;
...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    public Long submitOrder(OrderFormVo orderFormVo) {
        ...
        if(course == null) {
            throw new YaclassException(20001,"课程不存在");
        }

        //4 根据用户id查询用户信息
        UserInfo userInfo = userInfoFeignClient.getById(userId);
        if(userInfo == null) {
            throw new YaclassException(20001,"用户不存在");
        }
