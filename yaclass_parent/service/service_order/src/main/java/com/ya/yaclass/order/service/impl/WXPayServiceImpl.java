...
import com.ya.yaclass.order.service.WXPayService;
import com.ya.yaclass.utils.HttpClientUtils;
...
/**
 * @author yagote    create 2023/3/8 17:31
 */
@Service
    ...
    public Map<String, Object> createJsapi(String orderNo) {
        ...
        try {
            ...
            if(null != resultMap.get("result_code")  && !"SUCCESS".equals(resultMap.get("result_code"))) {
                throw new YaclassException(20001,"支付失败");
            }
