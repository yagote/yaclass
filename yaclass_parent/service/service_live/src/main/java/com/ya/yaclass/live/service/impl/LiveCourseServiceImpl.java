...
import com.ya.yaclass.client.course.CourseFeignClient;
import com.ya.yaclass.client.user.UserInfoFeignClient;
import com.ya.yaclass.exception.YaclassException;
import com.ya.yaclass.live.mtcloud.CommonResult;
import com.ya.yaclass.live.mtcloud.MTCloud;
import com.ya.yaclass.live.service.*;
import com.ya.yaclass.model.live.*;
import com.ya.yaclass.live.mapper.LiveCourseMapper;
import com.ya.yaclass.model.user.UserInfo;
import com.ya.yaclass.model.vod.Teacher;
import com.ya.yaclass.result.Result;
import com.ya.yaclass.utils.DateUtil;
import com.ya.yaclass.vo.live.*;
...
//         options 其他参数
        try {
            ...
            if(Integer.parseInt(commonResult.getCode()) == MTCloud.CODE_SUCCESS) { //成功
                ...
                throw new YaclassException(20001,"直播创建失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void removeLive(Long id) {
        ...
        if(liveCourse != null) {
            ...
            try {
                ...
                e.printStackTrace();
                throw new YaclassException(20001,"删除直播课程失败");
            }
        }
    }
    ...
    public void updateLiveById(LiveCourseFormVo liveCourseFormVo) {
        ...
        try {
            ...
            if(Integer.parseInt(commonResult.getCode()) == MTCloud.CODE_SUCCESS) {
                ...
                throw new YaclassException(20001,"修改直播课程失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public JSONObject getAccessToken(Long id, Long userId) {
        ...
        try {
            ...
            if(Integer.parseInt(commonResult.getCode()) == MTCloud.CODE_SUCCESS) {
                ...
                throw new YaclassException(20001,"获取失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void updateLifeConfig(LiveCourseConfigVo liveCourseConfigVo) {
        ...
        try {
            ...
            CommonResult<JSONObject> commonResult = JSON.parseObject(res, CommonResult.class);
            if(Integer.parseInt(commonResult.getCode()) != MTCloud.CODE_SUCCESS) {
                throw new YaclassException(20001,"修改配置信息失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
