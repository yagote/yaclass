package com.ya.yaclass.wechat.service.impl;

import com.ya.yaclass.client.course.CourseFeignClient;
import com.ya.yaclass.model.vod.Course;
import com.ya.yaclass.wechat.service.MessageService;
...
/**
 * @author yagote    create 2023/3/7 20:19
 */
@Service
public class MessageServiceImpl implements MessageService {
    ...
    private String aboutUs(Map<String, String> param) {
        StringBuffer msg = this.text(param, "Yaclass课堂现开设Java、HTML5前端+全栈、大数据、" +
    ...
    private String subscribe(Map<String, String> param) {
        return this.text(param,"感谢你关注“Yaclass课堂”，可以根据关键字搜索您想看的视频教程，如：JAVA基础、Spring boot、大数据等").toString();
    }
