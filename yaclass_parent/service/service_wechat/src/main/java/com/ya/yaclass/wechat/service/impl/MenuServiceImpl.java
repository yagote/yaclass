...
import com.ya.yaclass.wechat.mapper.MenuMapper;
import com.ya.yaclass.wechat.service.MenuService;
...
//    @Autowired
    ...
    public void removeMenu() {
        try {
            ...
            e.printStackTrace();
            throw new YaclassException(20001,"公众号菜单删除失败");
        }
    }
    ...
    public void syncMenu() {
        ...
        try {
            ...
            e.printStackTrace();
            throw new YaclassException(20001,"公众号菜单同步失败");
        }
    }
